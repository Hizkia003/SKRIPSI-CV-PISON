        ...
        <div class="jk-section" data-aos="fade-up" data-aos-delay="{{ $i * 80 }}">
            <div class="jk-layout">
                ...
                <div class="jk-right">
                    ...
                    {{-- Galeri Foto (maks 5 gambar horizontal) --}}
                    @if($j->images->count())
                    <div class="jk-gallery">
                        @foreach($j->images->take(5) as $img)
                        <a href="{{ asset('storage/'.$img->image) }}" class="jk-thumb" data-bs-toggle="modal" data-bs-target="#lightboxModal" data-img="{{ asset('storage/'.$img->image) }}" data-caption="{{ $j->title }} - Foto {{ $loop->iteration }}">
                            <img src="{{ asset('storage/'.$img->image) }}" alt="{{ $j->title }} - Foto {{ $loop->iteration }}" loading="lazy">
                            <div class="jk-thumb-overlay">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content bg-transparent border-0 shadow-none">
            ...
            <div class="modal-body p-0 text-center">
                <img id="lightboxImage" src="" alt="" class="img-fluid rounded-4" style="max-height:80vh; object-fit:contain;">
...
.jk-gallery {
    ...
    gap: 8px;
    max-width: 520px; /* batas lebar galeri agar tidak terlalu melar */
}
...
@media (max-width: 1199px) {
    ...
    .jk-number { font-size: 3.2rem; }
    .jk-gallery { max-width: 460px; }
}
