        ...
        <div class="row align-items-center min-vh-100">
            <div class="col-lg-7" data-aos="fade-right">
                ...
                <div class="hero-features mt-4">
                    <div class="feature-item"><i class="bi bi-check-circle-fill text-warning"></i> Sertifikat izin pendirian perusahaan</div>
                    <div class="feature-item"><i class="bi bi-check-circle-fill text-warning"></i> Harga Kompetitif</div>
                </div>
            </div>
...
<section class="section-padding bg-light">
    <div class="container">
        <div class="section-header text-center" data-aos="fade-up">
            ...
            <p class="section-desc">Kami menyediakan layanan supply material berkualitas dan jasa konstruksi profesional</p>
        </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="{{ $i * 100 }}">
                <div class="project-card">
                    ...
                    <div class="project-info">
                        <span class="project-category">{{ ucfirst($p->category) }} • {{ $p->year }}</span>
                        <h5>{{ $p->title }}</h5>
